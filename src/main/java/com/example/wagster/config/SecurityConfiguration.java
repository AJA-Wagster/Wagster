    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                .authorizeHttpRequests((requests) ->
                        ...
                        .requestMatchers("/posts/create", "/posts/{id}/edit", "/posts/*/delete", "/feed",  "/profile", "/profile/edit", "/profile/delete", "/events/create", "/events/{id}/edit", "/events/*/delete", "/location/create").authenticated()
